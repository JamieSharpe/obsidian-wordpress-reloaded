// Register all MathJax v4 TeX package configurations (base is registered by tex.js)
...
export const AllPackages = [
  'base',
  'action', 'ams', 'amscd', 'autoload', 'bbm', 'bboldx', 'bbox', 'begingroup',
  'boldsymbol', 'braket', 'bussproofs', 'cancel', 'cases', 'centernot',
  'color', 'colortbl', 'colorv2', 'configmacros', 'dsfont', 'empheq', 'enclose',
  'extpfeil', 'fontsizev3', 'gensymb', 'html', 'mathtools', 'mhchem',
  'newcommand', 'noerrors', 'noundefined', 'physics', 'require', 'setoptions',
